...
class _FirstPageState extends State<FirstPage> {
  ...
  String _serverImageFileUrl =
      'https://firebasestorage.googleapis.com/v0/b/musicminorleague.appspot.com/o/20201212%2Fy2hunter%2F2_image?alt=media&token=c4edb87d-9300-4c3d-9987-d0c0828334e7';
    ...
    await provider.sendImage(sendImageData).then(
      (value) {
        ...
        if (value['result'] == "True") {
          _serverImageFileUrl = 'http://10.0.2.2:8000' + value['path'];
          print('success');
